...
#   - Datasets:       data/qlcm/medical_qa_stage6/train.parquet     (3 378 rows; per-source duplication for epochs)
#                     data/qlcm/medical_qa_stage6/retention.parquet (2 013 rows)
#                     data/qlcm/medical_qa_stage6/val.parquet       (681 rows, take-all — no subsample)
...
#                       IF_USE_LLM_JUDGES; reads OPENROUTER_API_KEY from runtime_env.yaml.
...
ROLLOUT_DATA_DIR=${ROLLOUT_DATA_DIR:-/data/abdelrahman/verl/dumps/qlcm/medical_qa_stage6_rollouts}
VALIDATION_DATA_DIR=${VALIDATION_DATA_DIR:-/data/abdelrahman/verl/dumps/qlcm/medical_qa_stage6_val}
