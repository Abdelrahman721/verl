...
Usage:
    ...
    python -m qlcm.preprocess.verify_medical_qa_compat

    # Verify train.parquet end-to-end (316,287 rows, ~30s)
    python -m qlcm.preprocess.verify_medical_qa_compat --files train.parquet
...
from qlcm.preprocess.medical_qa_compat import transform_table
