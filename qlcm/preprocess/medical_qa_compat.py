...
to a JSON string so they can be concatenated with the qlcm retention
...
The qlcm parquets (ifeval / chat / safety / identity — including the
...
-----
    ...
    python -m qlcm.preprocess.medical_qa_compat
