...
# from qlcm.common.judge_client import JudgeUnavailable, call_judge, parse_json_object
...
def compute_score(solution_str: str, ground_truth, extra_info=None) -> float:
    ...
    def _is_pairwise_verdict(obj: dict) -> bool:
        v = obj.get("verdict")
    ...
    return _reward_from_verdict(obj["verdict"], policy_is_a)
