...
base seed (default 5051):
  ...
  1. General      (2 000)  — random from
                              data/qlcm/train/{chat_with_baseline,ifeval,safety}_train.parquet,
                              proportional to source size. Seed = base.
  2. Medical      (3 000)  — UNSEEN-only vs stage-1 rollouts
                              (data/qlcm/medical_qa_stage3/_stats_cache.json#stage1).
                              Seed = base + 1.
  3. Bench        (1 250)  — UNSEEN in BOTH:
                              - data/qlcm/medical_qa_stage4/_bench_retention_cache.json (bench rollouts)
                              - data/qlcm/medical_qa_stage5/_stage4_retention_cache.json (stage-4 coding rollouts)
                              Seed = base + 2.
  4. Coding-unmastered (ALL) — from stage-4 cache, mean_score < threshold,
                              indices into
                              data/qlcm/medical_qa_stage4/train_coding_only.parquet.
...
Output:
  ...
  data/qlcm/medical_qa_stage5/_retention_report.json
...
Usage:
    python -m qlcm.curriculum.build_medical_qa_stage5_retention \\
        --output_dir       /data/abdelrahman/verl/data/qlcm/medical_qa_stage5/
"""
...
from qlcm.curriculum.build_medical_qa_stage4 import (  # noqa: E402
    _REWARD_MODEL_CANONICAL_TYPE,
    _drop_non_canonical_columns,
)
from qlcm.curriculum.build_medical_qa_stage4_retention import (  # noqa: E402
...
def main():
    ...
    ap.add_argument("--bench_source",
                    default="/data/abdelrahman/verl/data/qlcm/medical_qa_stage3/train.parquet")
    ap.add_argument("--coding_source",
                    default="/data/abdelrahman/verl/data/qlcm/medical_qa_stage4/train_coding_only.parquet")
    ap.add_argument("--medical_cache",
                    default="/data/abdelrahman/verl/data/qlcm/medical_qa_stage3/_stats_cache.json")
    ap.add_argument("--bench_cache",
                    default="/data/abdelrahman/verl/data/qlcm/medical_qa_stage4/_bench_retention_cache.json")
    ap.add_argument("--stage4_cache",
                    default="/data/abdelrahman/verl/data/qlcm/medical_qa_stage5/_stage4_retention_cache.json")
    # Knobs.
