...
Three input streams are analysed:
  ...
  2. Stage-2 rollouts (`medical-qa-stage2`) against `data/qlcm/medical_qa_stage2/train.parquet`
...
Usage:
    python -m qlcm.curriculum.stats_medical_qa_stage3 \\
        ...
        --stage2_source      /data/abdelrahman/verl/data/qlcm/medical_qa_stage2/train.parquet \\
        ...
        --out                /data/abdelrahman/verl/data/qlcm/medical_qa_stage3/_stats_cache.json
"""
