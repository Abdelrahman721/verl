...
Three pools per user spec (seed family = 6051):
  ...
  1. General        (405 rows, seed=6051)
        ...
        Sources: data/qlcm/train/{chat_with_baseline,ifeval,safety}_train.parquet
  ...
  3. Stage-5 coding UNMASTERED (cap 1 000, seed=6053)
        ...
        Source: data/qlcm/medical_qa_stage5/train.parquet (35 120 coding rows).

Output:
  data/qlcm/medical_qa_stage6/retention.parquet
  data/qlcm/medical_qa_stage6/_retention_report.json
...
Usage:
    python -m qlcm.curriculum.build_medical_qa_stage6_retention \\
        --output_dir /data/abdelrahman/verl/data/qlcm/medical_qa_stage6/
"""
...
def main():
    ...
    ap.add_argument("--stage5_coding_source",
                    default="/data/abdelrahman/verl/data/qlcm/medical_qa_stage5/train.parquet")
    ...
    ap.add_argument("--stage5_cache",
                    default="/data/abdelrahman/verl/data/qlcm/medical_qa_stage6/_stage5_retention_cache.json")
