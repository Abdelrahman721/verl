...
matches each prompt against TWO source parquets:
  ...
  - data/qlcm/medical_qa_stage4/train_coding_only.parquet  (25 000 stage-4 coding rows)
        → ``coding_source_index`` for the **stage-4 unmastered pool**
          (mean_score < threshold defines unmastered).

  - data/qlcm/medical_qa_stage3/train.parquet (bench rows only, 17 193 of 21 193)
...
Usage:
    python -m qlcm.curriculum.stats_medical_qa_stage5_retention \\
        --rollout_dir   /data/abdelrahman/verl/coding_rollouts/medical_qa_stage4_rollouts \\
        --coding_source /data/abdelrahman/verl/data/qlcm/medical_qa_stage4/train_coding_only.parquet \\
        --bench_source  /data/abdelrahman/verl/data/qlcm/medical_qa_stage3/train.parquet \\
        --tokenizer     /data/abdelrahman/verl/checkpoints/QLCM/medical-qa-fresh/global_step_500/merged_hf_model \\
        --out           /data/abdelrahman/verl/data/qlcm/medical_qa_stage5/_stage4_retention_cache.json
"""
...
from qlcm.curriculum.stats_medical_qa_next import (  # noqa: E402
...
def main():
    ...
    ap.add_argument("--coding_source", required=True,
                    help="data/qlcm/medical_qa_stage4/train_coding_only.parquet")
    ap.add_argument("--bench_source",  required=True,
                    help="data/qlcm/medical_qa_stage3/train.parquet (bench rows are kept)")
