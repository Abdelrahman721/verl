...
Usage:
    python -m qlcm.curriculum.stats_medical_qa_stage6_retention \\
        --rollout_dir   /data/abdelrahman/verl/coding_ml_rollouts \\
        --coding_source /data/abdelrahman/verl/data/qlcm/medical_qa_stage5/train.parquet \\
        --tokenizer     /data/abdelrahman/verl/checkpoints/QLCM/medical-qa-fresh/global_step_500/merged_hf_model \\
        --out           /data/abdelrahman/verl/data/qlcm/medical_qa_stage6/_stage5_retention_cache.json
"""
...
def main():
    ...
    ap.add_argument("--coding_source", required=True,
                    help="data/qlcm/medical_qa_stage5/train.parquet")
