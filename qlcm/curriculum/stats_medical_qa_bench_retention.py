...
input back to its source row in `data/qlcm/medical_qa_stage3/train.parquet`
...
Usage:
    python -m qlcm.curriculum.stats_medical_qa_bench_retention \\
        --rollout_dir /data/abdelrahman/verl/medical_qa_benchmark_rollouts \\
        --source      /data/abdelrahman/verl/data/qlcm/medical_qa_stage3/train.parquet \\
        --tokenizer   /data/abdelrahman/verl/checkpoints/QLCM/medical-qa-fresh/global_step_500/merged_hf_model \\
        --out         /data/abdelrahman/verl/data/qlcm/medical_qa_stage4/_bench_retention_cache.json
"""
...
def main():
    ...
    ap.add_argument("--source", required=True,
                    help="data/qlcm/medical_qa_stage3/train.parquet")
