...
#   - Dataset:        data/medical_qa_stage3/train.parquet
...
ROLLOUT_DATA_DIR=${ROLLOUT_DATA_DIR:-$HOME/verl_dumps/medical_qa_stage3_rollouts}
VALIDATION_DATA_DIR=${VALIDATION_DATA_DIR:-$HOME/verl_dumps/medical_qa_stage3_val}
...
REWARD_FN_PATH=${REWARD_FN_PATH:-/workspace/verl/full_mix/rewards/qa_openrouter_bench.py}
