...
#   - Dataset:        data/medical_qa_stage4/train.parquet
...
#   - Reward fn:      full_mix/rewards/qa_openrouter_bench.py — OpenRouter
...
ROLLOUT_DATA_DIR=${ROLLOUT_DATA_DIR:-$HOME/verl_dumps/medical_qa_stage4_rollouts}
VALIDATION_DATA_DIR=${VALIDATION_DATA_DIR:-$HOME/verl_dumps/medical_qa_stage4_val}
...
# general-retention rows to the existing full_mix per-source scorer
...
#   * Retention rows (full_mix per-source: chat/safety/identity) ->
#     vLLM-served judge (or OpenRouter-served).                            Reads FULL_MIX_JUDGE_*
