...
#   - Datasets:       data/medical_qa_stage5/train.parquet     (35 120 stage-5 coding rows)
#                     data/medical_qa_stage5/retention.parquet (9 000 retention rows)
#                     data/medical_qa_stage5/val.parquet       (1 337 stage-5 coding val rows;
...
#                       Reads OPENROUTER_API_KEY from secrets.env.
#                       The labels JSON (sct_id -> description) ships INSIDE
#                       the coding package at
#                         full_mix/rewards/coding/instruction_following/labels/all_codes_to_descriptions_reconciled.json
...
# The FULL_MIX_JUDGE_* retention judge block is DROPPED for this stage
...
ROLLOUT_DATA_DIR=${ROLLOUT_DATA_DIR:-$HOME/verl_dumps/medical_qa_stage5_rollouts}
VALIDATION_DATA_DIR=${VALIDATION_DATA_DIR:-$HOME/verl_dumps/medical_qa_stage5_val}
