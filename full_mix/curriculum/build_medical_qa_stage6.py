...
Usage:
    python -m full_mix.curriculum.build_medical_qa_stage6 \\
        --output /data/abdelrahman/verl/data/medical_qa_stage6/
"""
...
_SOURCES = {
    ...
    "slb": {
        "train":     "/home/mbinakba/mcs-instruct-dataset/avey_icd_slb_rl_train_dataset.parquet",
        "val":       "/home/mbinakba/mcs-instruct-dataset/avey_icd_slb_rl_test_dataset.parquet",
        "task_type": "icd10_multilabel",
        "epochs":    1,
        "gold_kind": "list_like",
    },
