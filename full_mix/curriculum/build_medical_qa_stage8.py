...
identical to build_medical_qa_stage7.py except for the output dir
...
Usage:
    python -m full_mix.curriculum.build_medical_qa_stage8 \\
        --output /data/abdelrahman/verl/data/medical_qa_stage8/
"""
