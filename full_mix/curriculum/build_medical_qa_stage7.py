"""Assemble the medical_qa STAGE-7 train + val parquets (real coding, no SLB).
...
Usage:
    python -m full_mix.curriculum.build_medical_qa_stage7 \\
        --output /data/abdelrahman/verl/data/medical_qa_stage7/
"""
