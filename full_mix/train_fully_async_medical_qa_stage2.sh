...
#   - Dataset:        data/medical_qa_stage2/train.parquet
...
ROLLOUT_DATA_DIR=${ROLLOUT_DATA_DIR:-$HOME/verl_dumps/medical_qa_stage2_rollouts}
VALIDATION_DATA_DIR=${VALIDATION_DATA_DIR:-$HOME/verl_dumps/medical_qa_stage2_val}
...
# full mixed-source dispatcher (compute_score_medical_mix.py). No retention
# rows means no need for the retention branch or its key-padding logic.
REWARD_FN_PATH=${REWARD_FN_PATH:-/workspace/verl/full_mix/rewards/qa_openrouter.py}
