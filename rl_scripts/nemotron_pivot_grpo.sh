...
# (chat_template_tooling.jinja, which the llm-pretrainer SFT checkpoints save). Qwen3's official
# template would silently drop the earlier reasoning.
MODEL_PATH="models/Qwen3-4B-Base-tooling-sft"
