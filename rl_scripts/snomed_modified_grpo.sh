...
TRAIN_FILES="$HOME/data/snomed/snomed_synthesis_dataset_train.parquet"
VAL_FILES="$HOME/data/snomed/snomed_synthesis_dataset_test.parquet"

PROJECT_NAME="RL-Exps"
EXP_NAME="grpo++_snomed_setA"
