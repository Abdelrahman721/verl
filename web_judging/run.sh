...
# ---- policy / vLLM ----------------------------------------------------------
export POLICY_MODEL_PATH="${POLICY_MODEL_PATH:-/data/abdelrahman/verl/checkpoints/QLCM/medical-qa-stage8-coding/global_step_160/merged_hf_model}"
...
export POLICY_TP="${POLICY_TP:-1}"                 # tensor-parallel size (requirement: 2)
